...
import {FaCheckCircle,FaHourglassHalf,FaTimesCircle, FaMoneyBillWave,FaBuilding,FaUsers, FaFileAlt} from 'react-icons/fa'
        ...
        < div className="p-6">
            ...
            <div className="mt-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    ...
                    <SummaryCard icon={ <FaCheckCircle />} text ="Leave Approved" number={2} color= "bg-grey-600" />
